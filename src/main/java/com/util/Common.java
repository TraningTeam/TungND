...
public class Common {
     ...
     */
    public List<Integer> getListPaging(int totalUser, int currentPage, int limitPage) {
     ...
     */
    public int getStartPage(int currentPage, int totalPage) {
        if (totalPage > 5) {
     ...
     */
    public int getEndPage(int startPage, int limitPage, int totalPage) {
        if (totalPage > 5) {
     ...
     */
    public int getTotalPage(int totalUser, int limitPage) {
     ...
     */
    public boolean checkStringEmptyOrNull(String str) {
     ...
     */
    public boolean checkRegexInsuranceNumber(String insuranceNumber) {
     ...
     */
    public boolean checkValidInsuranceDate(String insuranceStartDate, String insuranceEndDate) {
     ...
     */
    public boolean checkRegexTelephone(String companyTelephone) {
     ...
     */
    public DateFormat setFormatValidDate() {
        DateFormat dateFormat = new SimpleDateFormat(Constant.FORMAT_DD_MM_YYYY);
