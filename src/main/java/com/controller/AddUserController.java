...
import com.properties.MessageErrorProperties;
...
public class AddUserController {
	...
	@Autowired
	private MessageErrorProperties messageErrorProperties;
	...
	@GetMapping("/addUser")
	public ModelAndView addUser(@ModelAttribute UserRegisterForm userRegisterForm) {
	...
	@PostMapping("/addUser")
	public ModelAndView calculator(@ModelAttribute UserRegisterForm userRegisterForm,
